...
if __name__ == "__main__":
    ...
    list_idx = pd.read_json(
        f"~/Softwares_Packages/Github/modl_uclouvain/shg-ml-benchmarks/data/{type_set}_id_{type_sampling}_{n_sampling}.json"
    )[0].tolist()
    path_set_matten = (
        f"../datasets/dataset_{type_set}_{type_sampling}_{n_sampling}.json"
    )
