...
class ModelCard:
    ...
    def tags(self):
        return (
            ...
            if self.in_context_learning else
            f"{self.label}-{self.input_structure_repr.value}" + "-no-icl"
        )
...
if os.getenv("OPENAI_API_KEY") is None:
    raise SystemExit("OPENAI_API_KEY not set in environment variables.")
